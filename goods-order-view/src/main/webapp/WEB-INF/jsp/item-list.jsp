...
<table class="easyui-datagrid" id="itemList" title="商品列表" 
       data-options="singleSelect:false,collapsible:true,pagination:true,url:'/goods/list',method:'get',pageSize:30,toolbar:toolbar">
    <thead>
        <tr>
            ...
            <th data-options="field:'price',width:100,align:'right',formatter:TAOTAO.formatPrice">价格</th>
        ...
        handler:function(){
        	...
        	$("#itemEditWindow").window({
        		onLoad :function(){
        			...
        			//加载商品规格
        			$.getJSON('/goods/query'+data.id,function(_data){
